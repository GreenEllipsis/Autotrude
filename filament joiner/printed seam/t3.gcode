; generated by PrusaSlicer 2.5.0+win64 on 2023-02-14 at 03:03:22 UTC
...
G1 X86 Y100 F599940
G1 E1 F600
G1 X104 Y100 E1 F600
G1 Y100.5
G1 X86 Y103.5 E1 F600
G1 Y99.5
G1 X104 Y96.5 E1 F600
G1 Y97.1
G1 X86 Y97.1 E0.5 F100
G1 Y97.7
G1 X104 Y97.7 E0.5 F100
G1 Y98.3
G1 X86 Y98.3 E0.5 F100
G1 Y98.9
G1 X104 Y98.9 E0.5 F100
G1 Y99.5
G1 X86 Y99.5 E0.5 F100
G1 Y100.3
G1 X104 Y100.3 E0.5 F100
G1 Y100.9
G1 X86 Y100.9 E0.5 F100
G1 Y101.5
G1 X104 Y101.5 E0.5 F100
G1 Y102.1
G1 X86 Y102.1 E0.5 F100
G1 Y102.7
G1 X104 Y102.7 E0.5 F100
G1 E-1 F2100
G1 Z5 F9999
M107
;TYPE:Custom
...
M73 P100 R0
M73 Q100 S0
; filament used [mm] = 8.51
; filament used [cm3] = 0.02
; filament used [g] = 0.02
; filament cost = 0.00
; total filament used [g] = 0.02
; total filament cost = 0.00
; estimated printing time (normal mode) = 20s
; estimated printing time (silent mode) = 20s
...
; filament_notes = "tested with Pepsi bottle"
; filament_ramming_parameters = "120 100 6.6 6.8 7.2 7.6 7.9 8.2 8.7 9.4 9.9 10.0| 0.05 6.6 0.45 6.8 0.95 7.8 1.45 8.3 1.95 9.7 2.45 10 2.95 7.6 3.45 7.6 3.95 7.6 4.45 7.6 4.95 7.6"
; filament_settings_id = rPET
; filament_soluble = 0
...
; perimeter_speed = 90
; perimeters = 8
; physical_printer_settings_id = Elastigirl MK3S
; post_process = 
; print_settings_id = 0.30mm 0.60 nozzle STRONG
; printer_model = 
; printer_notes = Don't remove the following keywords! These keywords are used in the "compatible printer" condition of the print and filament profiles to link the particular print and filament profiles to this printer profile.\nPRINTER_VENDOR_PRUSA3D\nPRINTER_MODEL_MK3\n
; printer_settings_id = MK3S 0.6
...
; start_gcode = M115 U3.1.3 ; tell printer latest fw version\nM201 X1000 Y1000 Z200 E5000 ; sets maximum accelerations, mm/sec^2\nM203 X200 Y200 Z12 E120 ; sets maximum feedrates, mm/sec\nM204 S1250 T1250 ; sets acceleration (S) and retract acceleration (T)\nM205 X10 Y10 Z0.4 E2.5 ; sets the jerk limits, mm/sec\nM205 S0 T0 ; sets the minimum extruding and travel feed rate, mm/sec\nM83  ; extruder relative mode\nM104 S[first_layer_temperature] ; set extruder temp\nM140 S[first_layer_bed_temperature] ; set bed temp\nM190 S[first_layer_bed_temperature] ; wait for bed temp\nM109 S[first_layer_temperature] ; wait for extruder temp\nG28 W ; home all without mesh bed level\nG80 ; mesh bed leveling\nG1 Y-3.0 F1000.0 ; go outside print area\nG92 E0.0\nG1 X60.0 E9.0  F1000.0 ; intro line\nG1 X100.0 E12.5  F1000.0 ; intro line\nG92 E0.0\nM221 S{if layer_height<0.075}100{else}95{endif}
; support_material = 1
